...
const navItems: NavItem[] = [
  ...
  },
  {
    icon: <BoxIcon/>,
    name: "Material Folio",
    path: "/dashboard/material-folio",
    subItems:[
      {name:"Orders",path:"/dashboard/material-folio/orders"},
      {name:"Vendors",path:"/dashboard/material-folio/vendors"},
      {name:"Contractors",path:"/dashboard/material-folio/contractors"},
    ]
  }
];
